...
![Example img](../../../../assets/documentation/reference/bpmn20/events/event-conditional.svg)Conditional Events Overview
...
![API Services](../../../../assets/documentation/reference/bpmn20/events/activityInstanceState.png)
