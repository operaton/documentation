...
![Input](../../../../assets/documentation/reference/dmn/decision-table/input.png)
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/input-label.png)Input Label" class="no-lightbox
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/input-expression.png)Input Expression" class="no-lightbox
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/input-type-definition.png)Input Type Definition" class="no-lightbox
