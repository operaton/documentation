...
![Example img](../../../assets/documentation/user-guide/process-engine/external-task-pattern.png)External Task Pattern
...
![Long polling to fetch and lock external tasks](../../../assets/documentation/user-guide/process-engine/external-task-long-polling.png)
