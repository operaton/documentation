...
String custom2 = start.getAttributeValueNs("custom-attribute-2", "http://operaton.org/custom");

// edit attributes by generic XML model API (with optional namespace)
start.setAttributeValue("custom-attribute", "new value");
start.setAttributeValueNs("custom-attribute", "http://operaton.org/custom", "new value");
```
...
<definitions targetNamespace="http://operaton.org/examples" xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL">
