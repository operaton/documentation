...
The full list of supported configuration parameters can be found [here](/docs/documentation/user-guide/spring-boot-integration/configuration/#operaton-engine-properties).
