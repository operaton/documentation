...
menu:
  main:
    ...
    description: "Invoke an EJB from a BPMN 2.0 Service Task."
...
:::note[Operaton dropped support for handling JPA entities as variables.]
Operaton is the last release that supports handling JPA entities as variables
...
![Example image](../../../assets/get-started/archive/javaee7/pizza-order-process-service-task-expression.png)
