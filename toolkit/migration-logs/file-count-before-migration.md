...
- docs\documentation\reference\cmmn11\concepts\img\CaseInstanceLifecycle.png
- docs\documentation\reference\cmmn11\concepts\img\example-lifecycle-case.png
- ... (417 more files)
- docs\get-started\quick-start\img\modeler-usertask5.png
...
- docs\get-started\quick-start\img\task-form-generated.png
- docs\get-started\quick-start\img\tasklist-dmn1.png
- docs\get-started\quick-start\img\tasklist-dmn2.png
- docs\get-started\spring-boot\img\eclipse-new-project.png
- docs\get-started\spring-boot\img\loanApproval.png
- docs\get-started\spring-boot\img\tasklist.png
...
- static\img\operaton_docs_start_icon_comp.png
- static\img\operaton_powered_by_java_icon.png
- static\img\operaton_powered_by_java_icon_comp.png

### .md

**In docs/ (410 files):**

- docs\documentation\examples\index.md
- docs\documentation\index.md
- docs\documentation\installation\camunda-modeler.md
- docs\documentation\installation\database-schema.md
- docs\documentation\installation\docker.md
- docs\documentation\installation\full\index.md
- docs\documentation\installation\full\tomcat\configuration.md
- docs\documentation\installation\full\tomcat\index.md
- docs\documentation\installation\full\tomcat\manual.md
- docs\documentation\installation\full\tomcat\pre-packaged.md
- ... (390 more files)
- docs\get-started\quick-start\service-task.md
- docs\get-started\quick-start\user-task.md
- docs\get-started\spring-boot\configuration.md
- docs\get-started\spring-boot\index.md
- docs\get-started\spring-boot\model.md
- docs\get-started\spring-boot\project-setup.md
- docs\intro.md
- docs\security\index.md
- docs\security\operations.md
- docs\security\report-vulnerability.md
...
- docs\documentation\reference\bpmn20\img\symbols\events\cancel_end_event.svg
- docs\documentation\reference\bpmn20\img\symbols\events\compensation_boundary_event.svg
- ... (66 more files)
...
- docs\documentation\user-guide\process-engine\img\bpmn-elements\timer-event.svg
...
- docs\documentation\reference\deployment-descriptors\tags\process-engine.mdx
- docs\documentation\reference\javadoc.mdx
- docs\documentation\user-guide\spring-boot-integration\configuration.mdx
