...
On the decision instance page, you find the table or literal expression of the executed decision as well as the values for the input variables and the decision result.
...
Rules that matched during the execution of the decision table are highlighted.

Furthermore, you can maximize the table view or the detailed information panel by clicking the <button class="btn btn-xs"><i class="glyphicon glyphicon-resize-full"></i></button> button or the <button class="btn btn-xs"><i class="glyphicon glyphicon-menu-up"></i></button> button at the bottom left of the table view.
