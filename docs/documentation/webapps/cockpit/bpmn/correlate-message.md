...
![Correlate Message Batch Operation](./../img/correlate-message/batch-operation.png)
...
![Process action to correlate a message](./../img/correlate-message/process-action.png)

If you click this button, a modal dialog opens:

![Modal dialog to correlate a message](./../img/correlate-message/modal-dialog.png)
...
![Diagram overlay button](./../img/correlate-message/diagram-overlay-button.png)
