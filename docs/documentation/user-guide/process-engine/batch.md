...
[history level]: ../user-guide/process-engine/history/history-configuration.md#choose-a-history-level
[history cleanup]: ../user-guide/process-engine/history/history-cleanup.md#history-time-to-live-for-batch-operations
...
[spring-boot-config]: ../user-guide/spring-boot-integration/configuration.md#operaton-engine-properties