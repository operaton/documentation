...
Therefore a new [FunctionMapper](https://jakarta.ee/specifications/platform/9/apidocs/jakarta/el/functionmapper) has to be implemented. The function mapper than
