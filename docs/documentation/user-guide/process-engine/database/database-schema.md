...
![Example img](../../../../assets/documentation/user-guide/process-engine/database/database-schema.png)Database Schema
...
![Example img](../../../../assets/documentation/user-guide/process-engine/database/erd_722_bpmn.svg)BPMN Tables


## Engine DMN

![Example img](../../../../assets/documentation/user-guide/process-engine/database/erd_722_dmn.svg)DMN Tables


## Engine CMMN

![Example img](../../../../assets/documentation/user-guide/process-engine/database/erd_722_cmmn.svg)CMMN Tables
...
![Example img](../../../../assets/documentation/user-guide/process-engine/database/erd_722_history.svg)History Tables


## Identity

![Example img](../../../../assets/documentation/user-guide/process-engine/database/erd_722_identity.svg)Identity Tables