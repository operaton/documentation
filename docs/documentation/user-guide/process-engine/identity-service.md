...
See the Spring Security OAuth2 Integration's [OAuth2 Identity Provider](../user-guide/spring-boot-integration/spring-security.md#oauth2-identity-provider) documentation.
