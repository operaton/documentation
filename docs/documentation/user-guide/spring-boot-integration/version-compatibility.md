...
Each version of the Operaton Spring Boot Starter is bound to a specific version of Operaton and Spring Boot.
...
:::note[Heads Up]
  Starting with version 7.13.0, Operaton and its compatible Spring Boot Starter always share the same version.
  Also, the Operaton version used in the Spring Boot Starter doesn't have to be overridden anymore. Simply pick
  the version of the Starter that resembles the version of Operaton you want to use.
:::
