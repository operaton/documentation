...
Some configuration can be done via Spring Boot configuration parameters. Check [the list of currently available parameters](/user-guide/spring-boot-integration/configuration.md#operaton-bpm-application).
