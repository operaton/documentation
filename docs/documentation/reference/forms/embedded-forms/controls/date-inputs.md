...
The Form SDK itself does not provide any custom components or widgets. As such it also does not provide a date picker. However, you can integrate third party libraries providing such widgets or write one yourself (see [Custom JavaScript](../reference/forms/embedded-forms/javascript/index.md)).
...
(see [Custom JavaScript](../reference/forms/embedded-forms/javascript/index.md)):
