...
menu:
  main:
    ...
    description: "Events catching / throwing escalations."
---
...
<subprocess triggeredByEvent="true">
  <startEvent id="catchEscalation" isInterrupting="false">
    <escalationEventDefinition operaton:escalationCodeVariable="code"/>
  </startEvent>
  <!-- ... -->
</subprocess>
```
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="../reference/bpmn20/custom-extensions/extension-attributes.md#escalationcodevariable">operaton:escalationCodeVariable</a>
    </td>
  </tr>
  <tr>
...
Two optional attributes can be added to the escalation boundary event, <code>escalationRef</code> and <code>escalationCodeVariable</code>, see [Escalation Start Event](#escalation-start-event).
