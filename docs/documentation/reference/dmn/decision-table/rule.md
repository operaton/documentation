...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/rule.png)Rule" class="no-lightbox
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/input-entry.png)Input Entry" class="no-lightbox
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/output-entry.png)Output Entry" class="no-lightbox
...
![Example img](../../../../assets/documentation/reference/dmn/decision-table/description.png)Description" class="no-lightbox
