...
The Standalone Web Application Distribution is no longer supported. Please use [another supported setup](../introduction/downloading-operaton.md#download-the-runtime) instead.
